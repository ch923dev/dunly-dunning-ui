...
- Tailwind 4: design tokens live in `src/index.css` under `@theme` (no tailwind.config file). Tokens mirror `./DESIGN.md` (lives in this repo) — change DESIGN.md first, then sync.
